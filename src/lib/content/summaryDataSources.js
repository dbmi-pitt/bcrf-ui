  ...
  dataSources: [
    {
      ...
      tags: [
        ...
        {
          name: 'Ethnicity',
          values: ['Hispanic/Latina', 'Not Hispanic/Latina', 'Unknown'],
        },
        {
          name: 'Family history of breast or ovarian cancer?',
          values: [false, true],
        },
        {
          name: 'Race',
        ...
        {
          name: 'Disease Free Status',
          values: ['1:Recurred/Progressed'],
        },
        {
        ...
        {
          name: 'Source of tissue used for mutational profile',
          display_type: 'collapsed',
          values: [
            'Metastatic tumor, post-treatment',
            'Metastatic tumor, pre-treatment',
            'NA',
            'Primary tumor pre-treatment',
            'Primary tumor, post-treatment',
          ],
        },
        {
        ...
        {
          name: 'Oncotree Code',
          values: ['BRCA', 'IDC', 'ILC', 'MDLC'],
        },
        {
          name: 'Overall Survival Status',
          values: ['0:LIVING', '1:DECEASED'],
        },
        {
          name: 'Participating site',
          values: [
        ...
        {
          name: 'Does the patient have a second breast primary?',
          values: [false, true],
        },
        {
        ...
        {
          name: 'Primary tumor HER2/neu Receptor status by IHC',
          values: ['0', '1+', '2+', '3+', 'NA', 'Unknown'],
        },
        {
          name: 'Is HER2 copy number known? (Primary tumor)',
          values: ['NA', 'No', 'Yes'],
        },
        {
          name: 'HER2 copy number for primary tumor',
          values: ['1.5', '1.7', 'NA'],
        },
        {
          name: 'Primary tumor HER2 FISH',
          values: ['Amplified', 'NA', 'Not amplified', 'Unknown'],
        },
        {
          name: 'Primary tumor HER2 status interpretation',
          values: ['Negative', 'Positive', 'Unknown'],
        },
        {
          name: 'Clinical M stage of first primary',
          values: ['M0', 'M1', 'Mx', 'Unknown'],
        },
        {
          name: 'Clinical N stage of first primary',
          values: ['Unknown', 'cN0', 'cN1', 'cN2', 'cN3', 'cNx'],
        },
        {
          name: 'Did patient receive a genomic prognostic assay for this tumor?',
          values: ['No', 'Unknown', 'Yes'],
        },
        {
          name: 'Source of genomic prognostic assay on first primary',
          values: ['NA', 'Oncotype DX'],
        },
        {
        ...
        {
          name: 'Clinical T stage of first primary',
          values: ['Unknown', 'cT1', 'cT2', 'cT3', 'cT4'],
        },
        {
          name: 'Did patient receive radiation for localized disease?',
          values: [false, true],
        },
        {
          name: 'Did patient receive radiation for metastatic disease?',
          values: [false, true],
        },
        {
        ...
        {
          name: 'Type of primary tumor final resection',
          values: [
        ...
        {
          name: 'Pathologic M',
          values: ['M0', 'M1', 'Mx', 'NA', 'Unknown'],
        },
        {
          name: 'Pathologic N',
          values: ['NA', 'Unknown', 'pN0', 'pN1', 'pN2', 'pN3', 'pNx'],
        },
        {
          name: 'Does the patient have a second breast primary?_1',
          values: ['No', 'Unknown', 'Yes'],
        },
        {
          name: 'Pathologic T',
          values: ['NA', 'Unknown', 'pT1', 'pT2', 'pT3', 'pT4'],
        },
        {
